...
public class ParamManager {
    ...
    private static ParamTest[] paramsCyclic = {
            new ParamTest("quietValue", "V", 0, -10, 10),
            new ParamTest("quietTime", "s", 0, 0, 3600),
...
//            new ParamTest("period", "s", 1000, 0, 172800),
//            new ParamTest("numCycles", "", 10, 1, 10000),
//            new ParamTest("shift", "", 0, 0, 1),
    };
...
//            new ParamTest("scan rate", "V/s", 0.5f, 0, 50)
            new ParamTest("quietValue", "V", 0, -10, 10),
            new ParamTest("quietTime", "s", 0, 0, 3600),
            new ParamTest("startValue", "V", -0.5f, -10, 10),
            new ParamTest("finalValue", "V", 0.5f, -10, 10),
            new ParamTest("duration", "s", 2000, 0, 10000),
    };
    ...
    private static ParamTest[] paramsConstantVoltage = {
            new ParamTest("quietValue", "V", 0, -10, 10),
            new ParamTest("quietTime", "s", 0, 0, 3600),
            new ParamTest("value", "V", 1, -10, 10),
            new ParamTest("duration", "s", 5000, 0, 172800)
    };
